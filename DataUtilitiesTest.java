...
public class DataUtilitiesTest {
    ...
    public void testCalculateRowTotalWithRowZero() {
        ...
        assertEquals("Total of the row should be 0", 0, result, 0);
    }
    ...
    public void testCalculateRowOneColumn() {
        ...
        assertEquals("Total of the row with one column should be 30", 30, result, 0);
    }
    ...
    public void testCreateNumberArrayWithSizeOne() {
        ...
        assertEquals("Array of values first value should be 5", 5, generated_list[0]);
    }
