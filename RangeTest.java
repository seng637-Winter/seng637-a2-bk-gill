...
public class RangeTest {
    ...
    public void intersectsWithUBAndAUB() {
    	assertTrue("Should return true due to intercept with UB",
    			this.exampleRange.intersects(60.0, 60.00001));
    }
    ...
    public void nullBaseInvalidParameterException() {
        ...
        try {
            ...
            fail("Expected InvalidParameterException but NullPointerException was thrown");
        } catch (InvalidParameterException e) {
            // Expected InvalidParameterException, test passes
        }
    }
